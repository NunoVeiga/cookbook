            ...
            <ul class="nav">
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a href="/recipes">Andr� Gra�a</a></li>
...
<input type="text" name="titulo" value="${titulo}"/></input></br>
<textarea rows="3" name="problema"/>${problema}</textarea><br></br>
<textarea rows="3" name="solucao"/>${solucao}</textarea><br></br>
<input type="text" name="autor" value="${autor}"/></input></br>
<input type="text" name="dificuldade" value="${dificuldade}"/></input></br>
<input type="text" name="tags" value="${tags}"/></input></br>
